...
from . import views, views_artists, views_venues, views_notes, views_users, ticketmaster_api
...
urlpatterns = [
    ...
    #API related
    path ('ticketmaster', ticketmaster_api.get_data, name = 'admin_get_venues_artists')
